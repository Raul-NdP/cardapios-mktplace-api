...
public interface CategoriasRepository extends JpaRepository<Categoria, Integer>{
	...
	@Query(value = "SELECT c "
			...
			+ "AND c.tipo = :tipo")
	public Categoria buscarPor(String nome, TipoCategoria tipo);
	...
	@Query(value = "SELECT c "
			...
			countQuery = "SELECT Count(c) "
					...
					+ "AND c.status = :status "
					+ "AND c.tipo = :tipo ")
	public Page<Categoria> listarPor(String nome, Status status, TipoCategoria tipo, Pageable paginacao);
