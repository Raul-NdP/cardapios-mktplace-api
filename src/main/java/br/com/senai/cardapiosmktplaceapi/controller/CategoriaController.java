...
public class CategoriaController {
	...
	@Transactional
	@PatchMapping("/id/{idCategoria}/status/{status}")
	public ResponseEntity<?> atualizarStatusPor(
		...
		this.service.atualizarStatusPor(idCategoria, status);
	...
	public ResponseEntity<?> excluirPor(
		...
		Categoria categoriaExcluida = service.excluirPor(idCategoria);
	...
	public ResponseEntity<?> listarPor(
		...
		Page<Categoria> categorias = service.listarPor(nomeCategoria, status, tipo, paginacao);
